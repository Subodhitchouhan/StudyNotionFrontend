...
//  const navigate = useNavigate(); 
 ...
 // const [toastStatus, settoastStatus] = useState(true)
  ...
  //adding toast notification for the first time when app loads 
  ...
  return (
    <div className="w-screen min-h-screen bg-[#000814] flex flex-col font-inter" >
      <Navbar/>
      <Routes>
            <Route path="/" element={<Home/>} />       {/* Home page ka route -->fetching Home.js file form the pages folder */}
