...
// Importing images for the timeline section
...
// Timeline data // this is the data that will be used to render the timeline section
const timeline = [
    {
        Logo: Logo1,
        heading: "Leadership",
...
// TimelineSection component code 
