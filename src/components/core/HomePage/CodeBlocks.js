...
// video ke niche wala section ka component hai 
//isme left side me heading , subheading or buttons hai jo hum CTAButton wale component se bana lenge 
// or right side me code block hai jo type animation wale component se bana lenge
const CodeBlocks = ({
  ...
  return (
    ...
    <div className='w-[100%] lg:w-[50%] flex flex-col gap-8'>
     ...
     {/*Section 2*/}   {/* right side wala part */}
