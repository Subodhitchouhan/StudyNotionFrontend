        ...
        const getCategories = async() => {
           ...
           //chatgpt code to fix eror           
                ...
                // setCategoryId(category_id);
                    ...
                    (ct) => ct.name.trim().toLowerCase() === catalogName.trim().toLowerCase()    //yeha bus ek space extra tha ouska error aaya tha 
                    );
                    ...
                    console.error("Category not found for catalog name:", catalogName);
                    setCategoryId(""); // fallback
                    }

                    console.log("Available Categories:", res?.data?.data.map((c) => c.name));
